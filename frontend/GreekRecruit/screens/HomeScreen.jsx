    ...
    <View>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Social Fraternities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Professional Fraternities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Social Sororities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Professional Sororities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Co-Ed Fraternities/Sororities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Cultural Fraternities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Cultural Sororities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Service Fraternities </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Service Sororities </Text>
            </TouchableOpacity>
            <TouchableOpacity
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Social Fraternity Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Professional Fraternity Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Social Sorority Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Professional Sorority Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Co-Ed Fraternity/Sorority Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Cultural Fraternity Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Cultural Sorority Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Service Fraternity Events </Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.modalButton}>
              <Text> Service Sorority Events </Text>
            </TouchableOpacity>
            <TouchableOpacity
